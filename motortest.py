...
def run_train_motor():
    ...
    try:
        ...
        if motor:
            ...
            print(f"⚠️ Warning: No motor detected or configured for Port {MOTOR_PORT.name}.")

    except Exception as e:
        print(f"\n❌ An error occurred during connection or operation: {e}")
        print("Troubleshooting: Is the hub turned on and advertising? Did you check the hub name?")
    finally:
        if hub:
